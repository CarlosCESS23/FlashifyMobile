...
- **Sentry** - Error tracking
- **ELK Stack** - Logs centralizados
>>>>>>> ce517dd (feat: implementação da ProfileImage utilizando a biblioteca Coil para processamento assíncrono. Documentação atualizada.)
...
- **Gabriel Fernandes** - *Full Stack Developer* - [GitHub](https://github.com/g-f307) | [LinkedIn](https://www.linkedin.com/in/gabriel-fernandes-7684b4220/)
- **Carlos Eduardo Souza** - *Front-end Developer* [GitHub](https://github.com/CarlosCESS23) | [LinkedIn](www.linkedin.com/in/carlos-souza-5843b11bb)
- **Rebecca Souza Xavier** - *UX/UI Designer*
- **Yasmim Pessoa da Frota**- *UX/UI Designer*
